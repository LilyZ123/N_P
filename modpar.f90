      ...
      type (precip_pet_moving_average), dimension(:),allocatable :: ppet
      !dimensioned by subbasin
...
!! septic variables for output.std
      ...
      real*8 :: bactmin, chla_subco, tb_adj, cn_froz, dorm_hr, smxco
...
! mhru = maximum number of hydrologic response units
      ...
      real*8, dimension (:),allocatable::pot_volmm,pot_tilemm,pot_volxmm
      ...
      real*8, dimension (:), allocatable :: twlpnd, twlwet          
      ...
      integer,dimension (:),allocatable::irr_sc,irr_no,irr_daymin
      integer,dimension (:),allocatable::irr_daycur
 ...
 !!     real*8, dimension (:,:), allocatable :: sol_mc, sol_mn, sol_mp
      ...
      lid_sw_last, interval_last,lid_f_last,lid_cumr_last,lid_str_last,&
       lid_farea,lid_qsurf,lid_sw_add,lid_cumqperc_last,lid_cumirr_last,&
        lid_excum_last,lid_str_curday,lid_qsurf_curday             
